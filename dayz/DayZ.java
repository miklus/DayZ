...
{	
    ...
    public static final Item camolegs = (new ItemCamo(3033, enumArmorMaterialCamo, 5, 2)).setUnlocalizedName("camolegs");
    public static final Item camoboots = (new ItemCamo(3034, enumArmorMaterialCamo, 5, 3)).setUnlocalizedName("camoboots");
