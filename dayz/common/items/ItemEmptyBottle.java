...
public class ItemEmptyBottle extends Item
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
    	...
    	{
    		case 0: this.itemIcon = par1IconRegister.registerIcon(Util.ID + ":waterBottleEmpty"); return;
    		case 1: this.itemIcon = par1IconRegister.registerIcon(Util.ID + ":emptyWhiskeyBottle"); return;
    		case 2: this.itemIcon = par1IconRegister.registerIcon(Util.ID + ":vodkaBottleEmpty"); return;
    		case 3: this.itemIcon = par1IconRegister.registerIcon(Util.ID + ":ciderBottleEmpty"); return;
    	}
    }
}
